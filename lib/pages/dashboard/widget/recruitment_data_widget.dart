...
class _RecruitmentDataWidgetState extends State<RecruitmentDataWidget> {
          ...
          Table(
            ...
            children: [
              ...
              tableRow(
                ...
                age: "21",
                address: "Samantha Homes, Bago Gallera",
              ),
            ],
          ),
          Container(
  ...
  TableRow tableRow(context, {name, image, age, address, color}) {
    return TableRow(
        decoration: BoxDecoration(
          border: Border(
            bottom: BorderSide(
        ...
        children: [
          ...
          // Designation
          if (!AppResponsive.isMobile(context)) Text(age),
          //Status
          Row(
            children: [
              Container(
